...
async function deleteAndReimport() {
  try {
    console.log('=== DELETING PASSAGE 85 ===');
    
    // Delete the passage (this will cascade delete related records)
    await prisma.ielts_reading_passages.delete({
      where: { id: 85 }
    });
    
    console.log('✅ Deleted passage 85');
    
    console.log('\n=== IMPORTING WITH FULL DATA ===');
    ...
    // Note: question_count field doesn't exist in schema, skipping update
